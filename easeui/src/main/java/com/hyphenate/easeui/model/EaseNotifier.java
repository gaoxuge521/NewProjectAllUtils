...
public class EaseNotifier {
    ...
    public void vibrateAndPlayTone(EMMessage message) {
        ...
        if (System.currentTimeMillis() - lastNotifiyTime < 1000) {
            // received newer messages within 2 seconds, skip play ringtone
            return;
        }
    ...
    public interface EaseNotificationInfoProvider {
        /**
         * set the notification content, such as "you received a newer image from xxx"
         * 
         * @param message
