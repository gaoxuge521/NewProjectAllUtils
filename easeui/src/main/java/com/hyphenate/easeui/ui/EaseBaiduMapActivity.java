...
public class EaseBaiduMapActivity extends EaseBaseActivity {
 // TODO: 2017/3/9  注释掉会话中发送地理位置功能
	...
	private int SETBUTTON_ENABLE = 0;
	...
	/**
	 * format newer location to string and show on screen
	 */
...
//			sendButton.setEnabled(true);
			mHandler.sendEmptyMessage(SETBUTTON_ENABLE);
