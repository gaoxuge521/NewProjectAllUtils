...
/**
 * 作者：Administrator on 2017/11/14 11:37
...
public class KeyboardUtils {
    ...
    public static void showSoftInput(final View view) {
        ...
        view.requestFocus();
        InputMethodManager imm = (InputMethodManager) BaseApplication.getmInstance().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
        imm.showSoftInput(view, InputMethodManager.SHOW_FORCED);
    }
