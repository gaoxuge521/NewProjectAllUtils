 ...
 *
 *
 *         用法： http://blog.csdn.net/itachi85/article/details/48291423
        ImageCompress compress = new ImageCompress();
         ImageCompress.CompressOptions options = new ImageCompress.CompressOptions();
         options.uri = Uri.fromFile(new File(sourcePath));
         options.maxWidth=Constants.RESIZEBITMAP_WIDTH;//可以不设置，默认400*400
         options.maxHeight=Constants.RESIZEBITMAP_HEIGHT;//可以不设置，默认400*400
